...
public abstract class SavePersonalAttributeList extends AbstractAction {
	...
	public String execute() {
		...
		String sp=session.getAttribute("sp").toString();//ptr
		...
		returnUrl = savePersonalAttributeList(token, pal,sp);//ptk
		if ( returnUrl==null ) {
	...
	protected abstract String savePersonalAttributeList(String token, IPersonalAttributeList pal, String sp);//ptk
